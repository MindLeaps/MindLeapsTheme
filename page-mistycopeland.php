<?php
/*
 * Template Name: Home Misty Copeland
 */
...
<style>
    ...
    .misty .left-side{ width: 58%; display: inline-block; position: absolute; /*top: -6px;*/ background: url('http://mindleaps.org/wp-content/uploads/2015/10/mistycopeland_november12to19.png') no-repeat; background-size: contain; height:100%; left: 0; }
    ...
    .misty .misty-slide .et_pb_slide_description{ text-align: center; padding: 60px; font-family: Helvetica, Arial, sans-serif; text-shadow: none; }
...
<div class="et_pb_section et_pb_fullwidth_section et_section_regular misty">
    <div class="et_pb_slider et_pb_slider_no_arrows et_slider_auto et_slider_speed_7000 et_pb_bg_layout_dark">
        <div class="et_pb_slides" style="position: relative;">
            <div class="et_pb_slide et_pb_bg_layout_dark et_pb_media_alignment_center misty-slide">
            ...
            <div class="et_pb_slide et_pb_bg_layout_dark et_pb_media_alignment_center et-pb-active-slide" style="background-color:#ffffff;background-image:url(https://res.cloudinary.com/mindleaps/image/upload/c_scale,h_768,q_80/v1444612690/ITTouch1-e1443808166464_v0jp54.jpg);">
			
                <div class="et_pb_container clearfix" style="min-height: 0px;">

                    <div class="et_pb_slide_description">
                        <h2><a href="/our-solution">Our Mission</a></h2>
                        <div class="et_pb_slide_content">
    <div class="et_pb_slide_content" style="text-align: center;">&nbsp;<strong>MindLeaps creates dance and educational programs for street children and out-of-school youth in post-conflict and developing countries. &nbsp;MindLeaps uses a kinesthetic-based curriculum to improve the cognitive skills of youth to ensure they can go to school, enter the workplace and leap forward in life.</strong></div>
    </div>
                        <a href="/our-solution" class="et_pb_more_button">Learn More</a>
