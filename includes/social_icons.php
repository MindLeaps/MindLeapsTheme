...
<li class="et-social-icon et-social-linkedin">
    <a href="http://in.linkedin.com/company/mindleaps" target="_blank" class="icon">
...
<li class="et-social-icon et-social-youtube">
    <a href="http://youtube.com/user/rebeccadavisdance" target="_blank" class="icon">
        <span><?php esc_html_e( 'YouTube', 'Divi' ); ?></span>
    </a>
</li>

<li class="et-social-icon et-social-instagram">
    <a href="http://www.instagram.com/mindleaps" target="_blank" class="icon">
